<template>
	<div class="home">
		<div class="index_top">
			<div class="index_top_title"><span>新能源车辆维修管理系统</span></div>
			<div class="index_top_right">
					<el-button class="notice-btn" @click="noticeDialogVisible=true">
						<span class="iconfont icon-chat--line"></span>
						系统公告
					</el-button>
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'weixiuyuan'){
