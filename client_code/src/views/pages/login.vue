	...
	<div>
		<div class="login_view">
			<div class="outTitle_view">
				<div class="outTilte">新能源车辆维修管理系统登录</div>
			</div>
...
<style lang="scss" scoped>
	.login_view {
        background-image: url("http://clfile.zggen.cn/20241030/b7b361dccedd47d19e106aefcdbf2d96.jpg");
		// 标题盒子
		.outTitle_view {
			.outTilte {
			}
...
.login_view {
    min-height: 100vh;
    position: relative;
    background: url(http://clfile.zggen.cn/20241030/b7b361dccedd47d19e106aefcdbf2d96.jpg) no-repeat center center / 100% 100%;
    display: flex;
