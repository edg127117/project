			...
			<div class="data_box">
				<div class="data_view">
					<div class="data_item" v-for="(item,index) in list" :key="index" @click.stop="detailClick(item.id)" >
						<div class="data_img_box" v-if="item.picture1 && item.picture1.substr(0,4)=='http'" @click.stop="preViewClick(item.picture1)">
							<el-image class="data_img" :src="item.picture1" fit="cover"></el-image>
						</div>
						<div class="data_img_box" v-else @click.stop="preViewClick($config.url+item.picture1.split(',')[0])">
							<el-image class="data_img" :src="item.picture1?$config.url + item.picture1.split(',')[0]:''"
								fit="cover"></el-image>
						</div>
