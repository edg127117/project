			...
			<el-row>
				<el-col :span="24">
					<el-form-item label="收费项目" prop="shoufeixiangmu">
						<el-input class="list_inp" v-model="form.shoufeixiangmu" placeholder="收费项目"
							 type="text" 							:readonly="!isAdd||disabledForm.shoufeixiangmu?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item label="收费详情" prop="shoufeixiangqing">
						<editor class="list_editor" :value="form.shoufeixiangqing" placeholder="请输入收费详情" :readonly="!isAdd||disabledForm.shoufeixiangqing?true:false"
							@change="(e)=>editorChange(e,'shoufeixiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.shoufeixiangqing = res.data.data.shoufeixiangqing.replace(reg,'../../../project/file');
