			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						<span>{{detail.shoufeixiangmu}}</span>
					</div>
				...
				<div class="info_item">
					<div class="info_label">执行标准</div>
					<div  class="info_text" >{{detail.zhixingbiaozhun}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('shoufeibiaozhun','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('shoufeibiaozhun','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<el-tabs type="border-card" v-model="activeName" class="tabs_view">
			<el-tab-pane label="收费详情" name="first">
				<div v-html="detail.shoufeixiangqing"></div>
			</el-tab-pane>
		</el-tabs>
	</div>
</template>
<script setup>
	...
	const getDetail = () => {
		context?.$http({
            ...
            title.value = res.data.data.shoufeixiangmu
