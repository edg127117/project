			...
			<div class="data_box">
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="维修账号" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="是否支付" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								...
								<el-button v-if="scope.row.ispay!='已支付' && btnAuth('weixiuxinxi','支付')" type="text" size="small" @click.stop="payClick(scope.row)">支付</el-button>
							</template>
						</el-table-column>
						<el-table-column label="故障位置" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.guzhangweizhi}}
							</template>
						</el-table-column>
						<el-table-column label="故障原因" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="检查报告" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								<el-button v-if="scope.row.jianchabaogao" type="text" size="small" @click.stop="download(scope.row.jianchabaogao)">下载</el-button>
								<el-button v-else disabled type="text" size="small">无</el-button>
							</template>
						</el-table-column>
						<el-table-column label="建议信息" :resizable='true' align="left" header-align="left">
							<template #default="scope">
