			...
			<div class="data_box">
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="车身颜色" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.cheshenyanse}}
							</template>
						</el-table-column>
						<el-table-column label="车辆图片" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								<div v-if="scope.row.cheliangtupian">
									<el-image v-if="scope.row.cheliangtupian.substring(0,4)=='http'" preview-teleported
										...
										:src="scope.row.cheliangtupian.split(',')[0]" style="width:100px;height:100px" @click.stop></el-image>
									<el-image v-else preview-teleported
										:preview-src-list="[$config.url+scope.row.cheliangtupian.split(',')[0]]"
										:src="$config.url+scope.row.cheliangtupian.split(',')[0]" style="width:100px;height:100px" @click.stop>
									</el-image>
								</div>
								<div v-else>无图片</div>
							</template>
